...
public class NetManager : NetworkManager
{
    ...
    public event Del_connect_id onConnectToServer_Stable;

    public event Del_connect onConnectToServer;

    public event Del_connect onClientConnect;

    public event Del_connect onDisconnect;

    public event Del_connect onPlayerLeft;
