...
public class UIContral : MonoBehaviour {
    ...
    //If the player plays the test card, they are able to fight back
    void FightBack()
    {
    ...
    //choose player, if they dead then skip them
